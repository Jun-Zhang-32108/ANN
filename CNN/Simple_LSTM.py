...
n_inputs = 28  # shape 28*28, 2D image
...
# Define weights
weights = {
    # (28,128) - weight matrix between input and hidden layer
    'in': tf.Variable(tf.random_normal([n_inputs, n_hidden_unis])),
    # (128,10) - weight matrix between hidden layer and output
    'out': tf.Variable(tf.random_normal([n_hidden_unis, n_classes]))
}

# Here we use constant 0.1 for the biases for both hidden layer and output layer
biases = {
    # (128,)
